...
export const getExperince = createAsyncThunk('experince/fetch', async( params, {getState}) =>{
...
const experincesSlice = createSlice({
    ...
    extraReducers: (builder) =>{
            builder.addCase(getExperince.pending, (state) =>{
                state.loading = true
            }).addCase(getExperince.fulfilled, (state, {payload: {data, pagination: {total}}})=>{
                state.loading = false
...
export const {controlModal, setSelected, setPage, controlBtnloading, refetch,setSearch} = actions
